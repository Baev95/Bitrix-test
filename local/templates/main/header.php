...
Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/	assets/css/bootstrap.min.css");
?>
...
<? $APPLICATION->ShowHead();?>
	...
	Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/css/shortcodes.css');
	...
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/waypoints.min.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/jquery.magnific-popup.min.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/jquery.mixitup.min.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/jquery.meanmenu.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/jquery.nav.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/jquery.parallax-1.1.3.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/animate-text.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/plugins.js');
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/assets/js/vendor/main.js');
        ...
        <div class="row z-index">
            <div class="col-md-7 col-sm-6">
                <div class="breadcrumb-title">
                    <h2 class="white-text"><?= $APPLICATION->ShowTitle(false) ?>
                </div>
            </div>
